...
const Page: Component<{}> = (props) => {
  return (
    <article class="container grid min-h-screen gap-8 pt-20">
      ...
      <p>
        This project is a request from my client Rocket Jaket. Rocket Jaket is a
        garment store who provides jacket collections, and also other garment
        like shirts, t-shirts, and also jeans pants. My client wanted a system
        that can help him manage all the store that he has easily and with good
        accountability. He also wanted the system can be accessed anywhere, so
        he can also monitor the stores while he's not on the location.
      </p>
      ...
      <ol class="list-decimal pl-4">
        ...
        <li>
          ...
          presence is only valid if employee is in 50 meter range from the store
          (GPS validation) and include a photo from the workplace.
        </li>
      </ol>
